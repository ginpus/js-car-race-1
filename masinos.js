...
do {
    ...
    if (maxKelias >= etapas + nuvaziuota) { // nuvaziuota didinamas tik etapo inkrementais. atspausdinam kas etapa. jei maxKelias pasieke etapo zingsni, rodomas laimetojas
        console.log(etapas + nuvaziuota, ' laimetojas:');
        ...
        nuvaziuota += etapas; // nuvaziuota padidinama etapo dydziu. kas reiskia, jog sekantis maxKelias tures but etapo dydziu (pvz., 100km) didesnis
    }
}
